...
public class SteakoutControllWindow {
	
	public JFrame steakoutControlFrame;
	public JTextField stkFileNameField;
	public JTextField stkFilePlaceField;
	public String prePostFixSelectedOption = "előtag";
	public String prePostFixValue = "KIT-";
	...
	public SteakoutControllWindow(String projectPathAndName, SteakoutController steakoutController) {
	...
	private void setSteakoutFileContentType() {
		...
		delimiterCombo.setSelectedItem(delimiterSelectedValue);
		String[] prePostFixType = {"pontszám", "előtag", "utótag"};
		JComboBox<String> prePostFixCombo = new JComboBox<>(prePostFixType);
		prePostFixCombo.setSelectedItem(prePostFixSelectedOption);
		...
		prePostFixCombo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				else if( "pontszám".equals(prePostFixSelectedOption) ) {
