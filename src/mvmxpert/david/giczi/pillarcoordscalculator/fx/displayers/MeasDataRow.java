...
public class MeasDataRow extends HBox {
	...
	private void changeTooltip(TextField textField) {
		Tooltip.install(textField, new Tooltip(textField.getText()));
	};
	...
	private void createRow() {
        ...
        standingPointNameField.setOnAction(even -> changeTooltip(standingPointNameField));
        ...
        standingPointYField.setOnAction(even -> changeTooltip(standingPointYField));
        ...
        standingPointXField.setOnAction(even -> changeTooltip(standingPointXField));
        ...
        standingPointZField.setOnAction(even -> changeTooltip(standingPointZField));
        ...
        totalStationHeightField.setOnAction(even -> changeTooltip(totalStationHeightField));
        ...
        measuredPointNameField.setOnAction(even -> changeTooltip(measuredPointNameField));
        ...
        measuredPointYField.setOnAction(even -> changeTooltip(measuredPointYField));
        ...
        measuredPointXField.setOnAction(even -> changeTooltip(measuredPointXField));
        ...
        measuredPointZField.setOnAction(even -> changeTooltip(measuredPointZField));
        ...
        measuredPointSignField.setOnAction(even -> changeTooltip(measuredPointSignField));
        ...
        horizontalAngleField.setOnAction(even -> changeTooltip(horizontalAngleField));
        ...
        verticalAngleField.setOnAction(even -> changeTooltip(verticalAngleField));
        ...
        horizontalDistanceField.setOnAction(even -> changeTooltip(horizontalDistanceField));
        ...
        measuredPointSignHeightField.setOnAction(even -> changeTooltip(measuredPointSignHeightField));
        ...
        dateField.setOnAction(even -> changeTooltip(dateField));
        dateField.setOnAction(even -> changeTooltip(dateField));
        ...
        theoreticalPointNameField.setOnAction(even -> changeTooltip(theoreticalPointNameField));
        ...
        theoreticalPointYField.setOnAction(even -> changeTooltip(theoreticalPointYField));
        ...
        theoreticalPointXField.setOnAction(even -> changeTooltip(theoreticalPointXField));
        ...
        theoreticalPointZField.setOnAction(even -> changeTooltip(theoreticalPointZField));
        ...
        theoreticalPointSignNameField.setOnAction(even -> changeTooltip(theoreticalPointSignNameField));
